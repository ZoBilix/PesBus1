package com.example.pesbuscom.search
...
class SearchManager(
    ...
    private fun updateSuggestions(query: String?) {
        ...
        // Остановки (названия) - УДАЛЕНО .distinctBy { it.name }, чтобы видеть все физические остановки
        stops.asSequence()
    ...
    private fun performSearch(query: String) {
        ...
        if (matchedStops.isNotEmpty()) {
            // Переходим к ближайшей из найденных, но не усредняем и не объединяем их
